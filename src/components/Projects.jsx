    ...
    <div>
      <div data-aos='fade-down'
        ...
        {projectStats.map((p, index) => (
          <div className='flex flex-col gap-2 items-center px-4 py-3 bg-[#5b093f] rounded-md'>
      ...
      className='w-full flex flex-wrap items-center justify-center gap-10 lg:gap-20 mt-16 '>
        {
          tools.map((t, index) => (
            <div className='flex gap-3 items-center bg-white rounded-md shadow-lg px-5 py-1' >
